...
std::shared_ptr<Material> Material::Create(std::shared_ptr<Texture> diffTex,
...
Material::Material() : Color(1.0f, 1.0f, 1.0f) { initDefaults(); }
Material::Material(std::shared_ptr<Texture> diffTex,
                   std::shared_ptr<Texture> roughTex,
                   std::shared_ptr<Texture> metTex,
                   std::shared_ptr<Texture> normalTex)
    : DiffuseMap(diffTex), RoughnessMap(roughTex), MetallicMap(metTex),
      NormalMap(normalTex), Color(1.0f, 1.0f, 1.0f)
{
}
